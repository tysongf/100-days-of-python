...
if choice1 == "land":
   ...
   if choice11 == "smoke":
      print("As you come nearer to the smoke you see what looks to be a small village of lizard people. They regard you with apprehension.")
      print("One of the villagers approaches you and raises his hand. He points at your supplies and makes a hissing noise.\n")
      ...
      if(choice111 == "give"):
         ...
         print("Satisfied that you do not have any weapons, he invites you to join the other villagers at the camp fire.")
         ...
         print("Unfortunately, the lizard people now regard you as a threat. They toss a net over you and wrestle you to the ground.")
      ...
      print("Or you could try to climb to the top of the mountain to see if you can get a good [radio] signal and call for help.\n")
